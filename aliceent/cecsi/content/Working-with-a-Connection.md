...
# Working with a Connection
  The following sections provide examples of the different ways to connect to a  SQL Server  database by using the [SQLServerConnection](../content/SQLServerConnection-Class.md) class of the  Microsoft JDBC Driver for SQL Server .  
  
> [!NOTE]  
>  If you have problems connecting to  SQL Server  using the JDBC driver, see [Troubleshooting Connectivity](../content/Troubleshooting-Connectivity.md) for suggestions on how to correct it.  
...
## Creating a Connection by Using the SQLServerDriver Class  
 If you have to specify a particular driver in the list of drivers for DriverManager, you can create a database connection by using the [connect](../content/connect-Method--SQLServerDriver-.md) method of the [SQLServerDriver](../content/SQLServerDriver-Class.md) class, as in the following:  
...
## Creating a Connection by Using the SQLServerDataSource Class  
 If you have to create a connection by using the [SQLServerDataSource](../content/SQLServerDataSource-Class.md) class, you can use various setter methods of the class before you call the [getConnection](../content/getConnection-Method---.md) method, as in the following:  
...
## Creating a Connection that Targets a Very Specific Data Source  
 ...
 For more connection URL examples, see [Building the Connection URL](../content/Building-the-Connection-URL.md).  
...
## Closing a Connection  
 You can explicitly close a database connection by calling the [close](../content/close-Method--SQLServerConnection-.md) method of the SQLServerConnection class, as in the following:  
