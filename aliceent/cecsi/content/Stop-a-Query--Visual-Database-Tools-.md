...
-   Right-click anywhere in the [Results pane](../content/Results-Pane--Visual-Database-Tools-.md), on the shortcut menu point to **Pane**, and then click **Clear Results**.  
