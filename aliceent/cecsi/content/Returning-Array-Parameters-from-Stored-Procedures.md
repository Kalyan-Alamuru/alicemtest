...
2.  Return each column as a single result set:  
 ...
 Ensure that your applications fetch all the result sets using the [SQLMoreResults](../content/Level-2-API-Functions--ODBC-Driver-for-Oracle-.md) API. For more information, refer to the *ODBC Programmer's Reference*.  
