...
## Remarks  
 This getColumnType method is specified by the getColumnType method in the java.sql.ResultSetMetaData interface.  
  ...
  Microsoft   SQL Server  JDBC Driver 3.0 has behavior changes in the DATA_TYPE column. See [SQLServerDatabaseMetaData.getColumns](../content/getColumns-Method--SQLServerDatabaseMetaData-.md) for more information.  
