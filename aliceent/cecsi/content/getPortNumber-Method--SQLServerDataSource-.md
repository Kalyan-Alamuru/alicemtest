...
> [!NOTE]  
>  The [setPortNumber](../content/setPortNumber-Method--SQLServerDataSource-.md) method does not do any range checking on the port value passed in. You can pass tort numbers that are not valid, like 99999, without triggering an error.  
