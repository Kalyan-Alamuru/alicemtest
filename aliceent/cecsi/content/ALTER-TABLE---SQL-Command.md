 ...
 *FieldType* is a single letter that indicates the field's [data type](../content/Visual-FoxPro-Field-Data-Types.md). Some field data types require that you specify *nFieldWidth* or *nPrecision* or both.  
