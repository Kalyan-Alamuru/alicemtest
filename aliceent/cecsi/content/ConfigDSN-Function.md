...
```  
 ...
 For more information about these keywords, see [SQLDriverConnect](../content/SQLDriverConnect-Function.md) and each driver's documentation.  
...
|Getting a value from the Odbc.ini file or the registry|[SQLGetPrivateProfileString](../content/SQLGetPrivateProfileString-Function.md)|  
|Removing the default data source|[SQLRemoveDefaultDataSource](../content/SQLRemoveDefaultDataSource-Function.md)|  
|Removing a data source name from Odbc.ini (or registry)|[SQLRemoveDSNFromIni](../content/SQLRemoveDSNFromIni-Function.md)|  
|Adding a data source name to Odbc.ini (or registry)|[SQLWriteDSNToIni](../content/SQLWriteDSNToIni-Function.md)|  
|Writing a value to the Odbc.ini file or the registry|[SQLWritePrivateProfileString](../content/SQLWritePrivateProfileString-Function.md)|