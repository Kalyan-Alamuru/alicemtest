...
|**SQLNativeSql**|For information about usage, see [Returning Array Parameters from Stored Procedures](../content/Returning-Array-Parameters-from-Stored-Procedures.md).|  
...
|**SQLSetScrollOptions**|Sets options that control the behavior of cursors associated with a statement handle, hstmt. For details, see [Cursor Type and Concurrency Combinations](../content/Cursor-Type-and-Concurrency-Combinations.md).|