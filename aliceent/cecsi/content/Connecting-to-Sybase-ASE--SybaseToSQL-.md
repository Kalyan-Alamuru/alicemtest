---
title: "Connecting to Sybase ASE (SybaseToSQL)"
ms.custom: na
ms.date: 07/18/2016
ms.reviewer: na
ms.suite: na
...
5.  If you select **Advanced mode**, provide a connection string in the **Connection string** box.  
    ...
    For more information, see [Connect to Sybase &#40;SybaseToSQL&#41;](../content/Connect-to-Sybase--SybaseToSQL-.md).  
...
-   The next step in the migration process is to [Connect to an instance of SQL Server](assetId:///dd368a1a-45b0-40e9-b4d3-5cdb48c26606) / [Connecting to an instance of SQL Azure](assetId:///9e77e4b0-40c0-455c-8431-ca5d43849aa7)  
