...
|REMARKS|When this value is true (1), the driver returns Remarks columns for the [SQLColumns](../content/Level-1-API-Functions--ODBC-Driver-for-Oracle-.md) result set. The ODBC Driver for Oracle provides faster access when this value is not set.|0|  
