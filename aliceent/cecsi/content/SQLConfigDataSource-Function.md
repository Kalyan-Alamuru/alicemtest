 ...
 **SQLConfigDataSource** adds, modifies, or deletes data sources.  
 ...
 The functionality of **SQLConfigDataSource** can also be accessed with [ODBCCONF.EXE](../content/ODBCCONF.EXE.md).  
 ...
 *lpszAttributes*  
 [Input] A doubly null-terminated list of attributes in the form of keyword-value pairs. For more information, see [ConfigDSN](../content/ConfigDSN-Function.md).  
...
|Removing a data source name from the system information|[SQLRemoveDSNFromIni](../content/SQLRemoveDSNFromIni-Function.md)|  
