...
# Using Database Metadata
  To query a database for information about what it supports, the  Microsoft JDBC Driver for SQL Server  implements the [SQLServerDatabaseMetaData](../content/SQLServerDatabaseMetaData-Class.md) class. This class contains numerous methods that return information in the form of a single value, or as a result set.  
