...
"VPA30890F" is the emp_id of the manager whose organization you want to retrieve. For more information about adding a user-defined function to a query, see [Add Tables to Queries &#40;Visual Database Tools&#41;](../content/Add-Tables-to-Queries--Visual-Database-Tools-.md). For a complete description of user-defined functions, see [User-Defined Functions](assetId:///d7ddafab-f5a6-44b0-81d5-ba96425aada4).  
