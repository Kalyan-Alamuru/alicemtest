---
title: "Create Insert Results Queries (Visual Database Tools)"
ms.custom: na
ms.date: 08/15/2016
...
3.  In the [Choose Target Table for Insert Results Dialog Box](../content/Choose-Target-Table-for-Insert-Results-Dialog-Box--Visual-Database-Tools-.md), select the table to copy rows to (the destination table).  
...
6.  If you want to copy rows in a particular order, specify a sort order. For details, see [Sort and Group Query Results &#40;Visual Database Tools&#41;](../content/Sort-and-Group-Query-Results--Visual-Database-Tools-.md).  
  
7.  Specify the rows to copy by entering search conditions in the **Filter** column. For details, see [Specify Search Criteria &#40;Visual Database Tools&#41;](../content/Specify-Search-Criteria--Visual-Database-Tools-.md).  
...
8.  If you want to copy summary information, specify Group By options. For details, see [Summarize Query Results &#40;Visual Database Tools&#41;](../content/Summarize-Query-Results--Visual-Database-Tools-.md).  
  
When you execute an Insert Results query, no results are reported in the [Results Pane](../content/Results-Pane--Visual-Database-Tools-.md). Instead, a message appears indicating how many rows were copied.  
