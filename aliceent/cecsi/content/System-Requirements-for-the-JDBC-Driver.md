...
## Java Runtime Environment Requirements  
 ...
 When you deploy the  Microsoft JDBC Driver for SQL Server  on Windows and UNIX operating systems, you must use the installation packages, *sqljdbc_<version\>_enu.exe* and *sqljdbc_<version\>_enu.tar.gz*, respectively. For more information about how to deploy the JDBC Driver, see [Deploying the JDBC Driver](../content/Deploying-the-JDBC-Driver.md) topic.  
