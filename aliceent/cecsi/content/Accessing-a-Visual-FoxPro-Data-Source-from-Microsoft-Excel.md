...
6.  In the [ODBC Visual FoxPro Setup dialog box](../content/ODBC-Visual-FoxPro-Setup-Dialog-Box.md), enter the data source name, select the Database type, enter the path to the database or directory, and click OK.  
...
8.  Click Use.  
 ...
 You can now add tables to the open query. For more information about building a query, see [Importing Data into Microsoft Excel from a Visual FoxPro Database](../content/Importing-Data-into-Microsoft-Excel-from-a-Visual-FoxPro-Database.md).