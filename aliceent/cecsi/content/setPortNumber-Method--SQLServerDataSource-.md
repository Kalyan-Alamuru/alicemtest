...
## Remarks  
 The port number is the TCP/IP port number that is used when opening a socket connection to  SQL Server . If the portNumber property is not set, the [getPortNumber](../content/getPortNumber-Method--SQLServerDataSource-.md) method returns the default value of 1433.  
