...
#### Parameters  
$*fetch_style*: An (integer) symbol specifying the format of the row data. See [PDOStatement::fetch](../Topic/PDOStatement::fetch.md) for a list of values. PDO::FETCH_COLUMN is also allowed. PDO::FETCH_BOTH is the default.  
