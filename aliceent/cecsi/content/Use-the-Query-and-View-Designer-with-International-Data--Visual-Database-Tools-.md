---
title: "Use the Query and View Designer with International Data (Visual Database Tools)"
ms.custom: na
ms.date: 08/15/2016
...
You can use the [Query and View Designer](../content/Query-and-View-Designer-Tools--Visual-Database-Tools-.md) with data in any language and in any version of the Windows operating system. The following guidelines outline the differences you will notice and provide information about managing data in international applications.  
