...
|Replaced application|Compatible|Compatible|Compatible|Not compatible[3]|  
 ...
 [5]   This configuration can potentially fail because there are features in ODBC 3.8 that are not in ODBC 2.x or 3.x drivers, such as driver-specific [C Data Types in ODBC](../content/C-Data-Types-in-ODBC.md).  
