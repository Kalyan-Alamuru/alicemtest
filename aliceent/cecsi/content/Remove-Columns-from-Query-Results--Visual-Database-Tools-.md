---
title: "Remove Columns from Query Results (Visual Database Tools)"
ms.custom: na
ms.date: 08/15/2016
...
> [!NOTE]  
> If you want to remove a column from the query altogether, see [Remove Columns from Queries &#40;Visual Database Tools&#41;](../content/Remove-Columns-from-Queries--Visual-Database-Tools-.md).  
...
-   Remove the column from the output list in the [SQL pane](../content/SQL-Pane--Visual-Database-Tools-.md).  
