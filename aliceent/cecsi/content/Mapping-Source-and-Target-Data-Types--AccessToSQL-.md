...
Access database types differ from  SQL Server  database types. When you convert Access database objects to  SQL Server  objects, you must specify how to map data types from Access to  SQL Server . You can accept the default data type mappings, or you can customize the mappings as shown in the following procedures.  
  
## Default Mappings  
SSMA has a default set of data type mappings. For the list of default mappings, see [Project Settings (Type Mapping)](assetId:///b87b9683-abed-4677-8c50-18bdba704655).  
...
## Next Steps  
The next step in the migration process is [convert access database objects to SQL Server objects](assetId:///e0ef67bf-80a6-4e6c-a82d-5d46e0623c6c)  
