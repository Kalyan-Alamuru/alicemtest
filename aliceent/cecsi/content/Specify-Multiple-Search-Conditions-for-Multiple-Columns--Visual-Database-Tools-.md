---
title: "Specify Multiple Search Conditions for Multiple Columns (Visual Database Tools)"
ms.custom: na
ms.date: 08/15/2016
...
1.  In the [Criteria Pane](../content/Criteria-Pane--Visual-Database-Tools-.md), add the columns you want to search.  
