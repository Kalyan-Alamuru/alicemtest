...
This topic describes how to make changes to the steps of a SQL Server Agent master job in SQL Server 2016 by using SQL Server Management Studio or  Transact\-SQL .  
...
6.  Click **Edit** to open the **Job Step Properties –***job_step_name* dialog box. For more information on the available options in this dialog box, see [Job Step Properties - New Job Step &#40;General Page&#41;](../content/Job-Step-Properties---New-Job-Step--General-Page-.md) and [Job Step Properties - New Job Step &#40;Advanced Page&#41;](../content/Job-Step-Properties---New-Job-Step--Advanced-Page-.md).  
...
For more information, see [sp_update_jobstep (Transact-SQL)](assetId:///e158802c-c347-4a5d-bf75-c03e5ae56e6b).  
