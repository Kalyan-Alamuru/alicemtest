...
The identifier for the time ODBC C data type is:  
 ...
 The following table shows the ODBC SQL data types to which time C data may be converted. For an explanation of the columns and terms in the table, see [Converting Data from C to SQL Data Types](../content/Converting-Data-from-C-to-SQL-Data-Types.md).  
...
|SQL_TYPE_TIMESTAMP|Data value is a valid time[a]<br /><br /> Data value is not a valid time|n/a<br /><br /> 22007|  
 ...
 For information about what values are valid in a SQL_C_TYPE_TIME structure, see [C Data Types](../content/C-Data-Types.md), earlier in this appendix.  
