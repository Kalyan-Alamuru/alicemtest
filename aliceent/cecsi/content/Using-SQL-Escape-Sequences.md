---
title: "Using SQL Escape Sequences"
ms.custom: na
ms.date: 07/18/2016
...
```  
 ...
 For more information about using the `call` escape sequence with stored procedures, see [Using Statements with Stored Procedures](../content/Using-Statements-with-Stored-Procedures.md).  
