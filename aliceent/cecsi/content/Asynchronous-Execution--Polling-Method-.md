...
||||  
|-|-|-|  
|[SQLBulkOperations](../content/SQLBulkOperations-Function.md)|[SQLColAttribute](../content/SQLColAttribute-Function.md)|[SQLColumnPrivileges](../content/SQLColumnPrivileges-Function.md)|  
|[SQLColumns](../content/SQLColumns-Function.md)|[SQLDescribeCol](../content/SQLDescribeCol-Function.md)|[SQLDescribeParam](../content/SQLDescribeParam-Function.md)|  
|[SQLExecDirect](../content/SQLExecDirect-Function.md)|[SQLExecute](../content/SQLExecute-Function.md)|[SQLFetch](../content/SQLFetch-Function.md)|  
|[SQLFetchScroll](../content/SQLFetchScroll-Function.md)|[SQLForeignKeys](../content/SQLForeignKeys-Function.md)|[SQLGetData](../content/SQLGetData-Function.md)|  
|[SQLGetTypeInfo](../content/SQLGetTypeInfo-Function.md)|[SQLMoreResults](../content/SQLMoreResults-Function.md)|[SQLNumParams](../content/SQLNumParams-Function.md)|  
|[SQLNumResultCols](../content/SQLNumResultCols-Function.md)|[SQLParamData](../content/SQLParamData-Function.md)|[SQLPrepare](../content/SQLPrepare-Function.md)|  
|[SQLPrimaryKeys](../content/SQLPrimaryKeys-Function.md)|[SQLProcedureColumns](../content/SQLProcedureColumns-Function.md)|[SQLProcedures](../content/SQLProcedures-Function.md)|  
|[SQLPutData](../content/SQLPutData-Function.md)|[SQLSetPos](../content/SQLSetPos-Function.md)|[SQLSpecialColumns](../content/SQLSpecialColumns-Function.md)|  
|[SQLStatistics](../content/SQLStatistics-Function.md)|[SQLTablePrivileges](../content/SQLTablePrivileges-Function.md)|[SQLTables](../content/SQLTables-Function.md)|  
  
 Asynchronous statement execution is controlled on either a per-statement or a per-connection basis, depending on the data source. That is, the application specifies not that a particular function is to be executed asynchronously, but that any function executed on a particular statement is to be executed asynchronously. To find out which one is supported, an application calls [SQLGetInfo](../content/SQLGetInfo-Function.md) with an option of SQL_ASYNC_MODE. SQL_AM_CONNECTION is returned if connection-level asynchronous execution (for a statement handle) is supported; SQL_AM_STATEMENT if statement-level asynchronous execution is supported.  
...
-   [SQLCancel](../content/SQLCancel-Function.md)  
  
-   [SQLCancelHandle](../content/SQLCancelHandle-Function.md) (on the statement handle)  
  
-   [SQLGetDiagField](../content/SQLGetDiagField-Function.md)  
  
-   [SQLGetDiagRec](../content/SQLGetDiagRec-Function.md)  
  
-   [SQLAllocHandle](../content/SQLAllocHandle-Function.md)  
  
-   [SQLGetEnvAttr](../content/SQLGetEnvAttr-Function.md)  
  
-   [SQLGetConnectAttr](../content/SQLGetConnectAttr-Function.md)  
  
-   [SQLDataSources](../content/SQLDataSources-Function.md)  
  
-   [SQLDrivers](../content/SQLDrivers-Function.md)  
  
-   [SQLGetInfo](../content/SQLGetInfo-Function.md)  
  
-   [SQLGetFunctions](../content/SQLGetFunctions-Function.md)  
  
-   [SQLNativeSql](../content/SQLNativeSql-Function.md)  
...
## Executing Connection Operations Asynchronously  
 ...
 For more information on ODBC 3.8, see [What's New in ODBC 3.8](../content/What-s-New-in-ODBC-3.8.md).  
...
||||  
|-|-|-|  
|[SQLBrowseConnect](../content/SQLBrowseConnect-Function.md)|[SQLConnect](../content/SQLConnect-Function.md)|[SQLDisconnect](../content/SQLDisconnect-Function.md)|  
|[SQLDriverConnect](../content/SQLDriverConnect-Function.md)|[SQLEndTran](../content/SQLEndTran-Function.md)|[SQLSetConnectAttr](../content/SQLSetConnectAttr-Function.md)|  
...
-   **SQLGetFunctions**  
 ...
 Asynchronous connection operations and **SQLCancelHandle** can also be used by ODBC 3.x and ODBC 2.x applications with an ODBC 3.8 driver and ODBC 3.8 Driver Manager. For information about for how to enable an older application to use new features in later ODBC version, see [Compatibility Matrix](../content/Compatibility-Matrix.md).  
