 ...
 *fSqlType*  
 [Input] The SQL data type. This argument tells the driver how to convert *rgbValueIn* into a form acceptable by the application. For a list of valid SQL data types, see the [SQL Data Types](../content/SQL-Data-Types.md) section in Appendix D: Data Types.  
...
|---------------------------|---------|  
|Translating data being sent to the data source|[SQLDriverToDataSource](../content/SQLDriverToDataSource-Function.md)|  
