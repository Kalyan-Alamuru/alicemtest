...
This topic describes how to add steps to a SQL Server Agent master job in SQL Server 2016 by using SQL Server Management Studio or  Transact\-SQL .  
...
5.  In the **Job Properties –***job_name* dialog box, under **Select a page**, select **Steps**. For more information on the available options on this page, see [Job Properties - New Job &#40;Steps Page&#41;](../content/Job-Properties---New-Job--Steps-Page-.md).  
