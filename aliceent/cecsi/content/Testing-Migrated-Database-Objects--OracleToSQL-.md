...
SSMA Tester executes objects selected for testing on Oracle and their counterparts in  SQL Server . After that, it compares the results according to the following criteria:  
...
-   Oracle client tools are installed on the computer where  SQL Server  runs.  
