...
|SQL_CURSOR_TYPE|SQL_CURSOR_FORWARD_ONLY<br /><br /> SQL_CURSOR_STATIC|The driver does not allow SQL_CURSOR_KEYSET_DRIVEN or SQL_CURSOR_DYNAMIC; see [SQLSetScrollOptions](../content/SQLSetScrollOptions--Visual-FoxPro-ODBC-Driver-.md) for more information.|  
...
|SQL_USE_BOOKMARKS|SQL_UB_OFF<br /><br /> SQL_UB_ON||  
 ...
 For more information, see [SQLSetStmtOption](../content/SQLSetStmtOption-Function.md) in the *ODBC Programmer's Reference*.