...
If you are using the SQLSRV driver, [sqlsrv_client_info](../content/sqlsrv_client_info.md) will return information about which version of  SQL Server  Native Client or Microsoft ODBC Driver for SQL Server is being used by the Microsoft Drivers for PHP for SQL Server. If you are using the PDO_SQLSRV driver, you can use [PDO::getAttribute](../Topic/PDO::getAttribute.md) to discover the version.  
