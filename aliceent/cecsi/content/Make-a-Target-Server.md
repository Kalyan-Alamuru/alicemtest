...
This topic describes how to make a target server in SQL Server 2016 by using SQL Server Management Studio,  Transact\-SQL , or SQL Server Management Objects (SMO).  
