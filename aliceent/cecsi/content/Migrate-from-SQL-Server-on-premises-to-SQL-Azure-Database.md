---
title: "Migrate from SQL Server on premises to SQL Azure Database"
ms.custom: na
ms.date: 08/04/2016
ms.reviewer: na
ms.suite: na
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: d3a2031c-ec98-4bb1-9d5b-9b14b8cb6411
caps.latest.revision: 2
---
# Migrate from SQL Server on premises to SQL Azure Database
