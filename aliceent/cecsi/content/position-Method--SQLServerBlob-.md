...
|Name|Description|  
|----------|-----------------|  
|[position (java.sql.Blob, long)](../content/position-Method--java.sql.Blob--long-.md)|Returns the position of a specified pattern in the BLOB based on the given pattern and the starting index.|  
|[position (byte&#91;&#93;, long)](../content/position-Method--byte--long-.md)|Returns the position of a specified pattern in the BLOB based on the given **byte** array pattern and the starting index.|  
