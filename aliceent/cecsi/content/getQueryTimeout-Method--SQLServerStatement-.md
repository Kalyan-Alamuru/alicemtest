...
# getQueryTimeout Method (SQLServerStatement)
  Retrieves the number of seconds  Microsoft JDBC Driver for SQL Server  will wait for this [SQLServerStatement](../content/SQLServerStatement-Class.md) object to run.  
