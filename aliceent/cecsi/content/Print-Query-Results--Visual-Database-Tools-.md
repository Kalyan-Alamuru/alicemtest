---
title: "Print Query Results (Visual Database Tools)"
ms.custom: na
ms.date: 08/15/2016
...
To print the results of your query, you can copy the contents of the [Results pane](../content/Results-Pane--Visual-Database-Tools-.md) to another Windows program, such as a word processing program, then format and print it there.  
