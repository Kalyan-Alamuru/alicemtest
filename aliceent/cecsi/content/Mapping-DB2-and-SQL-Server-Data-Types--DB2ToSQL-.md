...
DB2 database types differ from  SQL Server  database types. When you convert DB2 database objects to  SQL Server  objects, you must specify how to map data types from DB2 to  SQL Server . You can accept the default data type mappings, or you can customize the mappings as shown in the following sections.  
  
## Default Mappings  
SSMA has a default set of data type mappings. For the list of default mappings, see [Project Settings &#40;Type Mapping&#41; &#40;DB2ToSQL&#41;](../content/Project-Settings--Type-Mapping---DB2ToSQL-.md).  
...
## Next Steps  
The next step in the migration process is to either [Assessment Report &#40;DB2ToSQL&#41;](../content/Assessment-Report--DB2ToSQL-.md) or [Converting DB2 Schemas &#40;DB2ToSQL&#41;](../content/Converting-DB2-Schemas--DB2ToSQL-.md). If you create an assessment report, DB2 objects are automatically converted during the assessment.  
