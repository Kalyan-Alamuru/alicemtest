...
The identifiers for the character ODBC SQL data types are:  
 ...
 The following table shows the ODBC C data types to which character SQL data may be converted. For an explanation of the columns and terms in the table, see [Converting Data from SQL to C Data Types](../content/Converting-Data-from-SQL-to-C-Data-Types.md).  
...
_C_BIT|Data is 0 or 1<br /><br /> Data is greater than 0, less than 2, and not equal to 1<br /><br /> Data is less than 0 or greater than or equal to 2<br /><br /> Data is not a *numeric-literal*|Data<br /><br /> Truncated data<br /><br /> Undefined<br /><br /> Undefined|1[b]<br /><br /> 1[b]<br /><br /> Undefined<br /><br /> Undefined|n/a<br /><br /> 01S07<br /><br /> 22003<br /><br /> 22018|  
