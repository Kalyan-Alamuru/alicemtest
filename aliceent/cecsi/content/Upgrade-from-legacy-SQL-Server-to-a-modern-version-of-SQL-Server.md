---
title: "Upgrade from legacy SQL Server to a modern version of SQL Server"
ms.custom: na
ms.date: 08/04/2016
ms.reviewer: na
ms.suite: na
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: f1d0e79f-329f-4ca1-93fc-f1c72953314b
caps.latest.revision: 2
---
# Upgrade from legacy SQL Server to a modern version of SQL Server
