...
-   Fetch a set of rows where each row is identified by a bookmark.  
 ...
 For more information about how to use **SQLBulkOperations**, see [Updating Data with SQLBulkOperations](../content/Updating-Data-with-SQLBulkOperations.md).  
...
5.  If the application has set the SQL_ATTR_ROW_STATUS_PTR statement attribute, it can inspect this array to see the result of the operation.  
 ...
 It is not necessary for the application to call **SQLFetch** or **SQLFetchScroll** before it calls **SQLBulkOperations** (except when going against an ODBC 2.*x* driver; see [Backward Compatibility and Standards Compliance](../content/Backward-Compatibility-and-Standards-Compliance.md)).  
...
|Positioning the cursor, refreshing data in the rowset, or updating or deleting data in the rowset|[SQLSetPos Function](../content/SQLSetPos-Function.md)|  
