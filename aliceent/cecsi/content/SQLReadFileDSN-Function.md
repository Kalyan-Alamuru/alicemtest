...
## Comments  
 ODBC reserves the section name [ODBC] in which to store the connection information. The reserved keywords for this section are the same as those reserved for a connect string in **SQLDriverConnect**. (For more information, see the [SQLDriverConnect](../content/SQLDriverConnect-Function.md) function description.)  
...
|---------------------------|---------|  
|Writing information to a File DSN|[SQLWriteFileDSN](../content/SQLWriteFileDSN-Function.md)|