...
# executeUpdate Method (java.lang.String, int)
  Runs the given SQL statement and signals the  Microsoft JDBC Driver for SQL Server  with the given flag about whether the auto-generated keys that are produced by this [SQLServerStatement](../content/SQLServerStatement-Class.md) object should be made available for retrieval.  
