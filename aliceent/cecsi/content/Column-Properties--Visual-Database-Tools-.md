---
title: "Column Properties (Visual Database Tools)"
ms.custom: na
ms.date: 08/15/2016
...
**Data Type**  
Shows the data type of the selected column. For more information, see [Data Types (Transact-SQL)](assetId:///a54f7373-b247-4d61-8fb8-7f2ec7a8d0a4).  
...
**Data Type**  
Shows the data type for the selected column. To edit this property, click its value, expand the drop-down list, and choose another value. For more information, see [Data Types (Transact-SQL)](assetId:///a54f7373-b247-4d61-8fb8-7f2ec7a8d0a4).  
...
Select whether to enable statistical semantic indexing for the selected column. For more information, see [Semantic Search placeholder](assetId:///cd8faa9d-07db-420d-93f4-a2ea7c974b97).  
