 ...
 **SQLInstallDriverEx** adds information about the driver to the Odbcinst.ini entry in the system information and increments the driver's *UsageCount* by 1. However, if a version of the driver already exists but the *UsageCount* value for the driver does not exist, the new *UsageCount* value is set to 2.  
 ...
 The functionality of **SQLInstallDriverEx** can also be accessed with [ODBCCONF.EXE](../content/ODBCCONF.EXE.md).  
...
> [!NOTE]  
>  For more information about component usage counts and file usage counts, see [Usage Counting](../content/Usage-Counting.md).  
...
|---------------------------|---------|  
|Installing the Driver Manager|[SQLInstallDriverManager](../content/SQLInstallDriverManager-Function.md)|