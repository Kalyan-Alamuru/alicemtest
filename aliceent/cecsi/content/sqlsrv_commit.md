...
---
# sqlsrv_commit
Commits the current transaction on the specified connection and returns the connection to the auto-commit mode. The current transaction includes all statements on the specified connection that were executed after the call to [sqlsrv_begin_transaction](../content/sqlsrv_begin_transaction.md) and before any calls to [sqlsrv_rollback](../content/sqlsrv_rollback.md) or **sqlsrv_commit**.  
