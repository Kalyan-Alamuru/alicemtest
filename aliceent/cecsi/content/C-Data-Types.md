...
|All C interval data types|SQL_INTERVAL_STRUCT|See the [C Interval Structure](../content/C-Interval-Structure.md) section, later in this appendix.|  
...
```  
 ...
 [a]   The values of the year, month, day, hour, minute, and second fields in the datetime C data types must conform to the constraints of the Gregorian calendar. (See [Constraints of the Gregorian Calendar](../content/Constraints-of-the-Gregorian-Calendar.md) later in this appendix.)  
