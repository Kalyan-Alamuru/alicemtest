...
---
# Connection Options
This topic lists the options that are permitted in the associative array (when using [sqlsrv_connect](../content/sqlsrv_connect.md) in the SQLSRV driver) or the keywords that are permitted in the data source name (dsn) (when using [PDO::__construct](../Topic/PDO::__construct.md) in the PDO_SQLSRV driver).  
...
|CharacterSet<br /><br />(not supported in the PDO_SQLSRV driver)|String|Specifies the character set used to send data to the server.<br /><br />Possible values are SQLSRV_ENC_CHAR and UTF-8. For more information, see [How to: Send and Retrieve UTF-8 Data Using Built-In UTF-8 Support](../Topic/How%20to:%20Send%20and%20Retrieve%20UTF-8%20Data%20Using%20Built-In%20UTF-8%20Support.md).|SQLSRV_ENC_CHAR|  
