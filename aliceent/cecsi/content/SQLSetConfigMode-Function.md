...
|---------------------------|---------|  
|Creating a data source|[SQLCreateDataSource](../content/SQLCreateDataSource-Function.md)|  
|Connecting to a data source using a connection string or dialog box|[SQLDriverConnect](../content/SQLDriverConnect-Function.md)|  
|Retrieving the configuration mode|[SQLGetConfigMode](../content/SQLGetConfigMode-Function.md)|