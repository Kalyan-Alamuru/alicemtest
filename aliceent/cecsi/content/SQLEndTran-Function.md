...
|HY008|Operation canceled|Asynchronous processing was enabled for the *ConnectionHandle*. The function was called, and before it finished executing [SQLCancelHandle Function](../content/SQLCancelHandle-Function.md) was called on the *ConnectionHandle*. Then the function was called again on the *ConnectionHandle*.<br /><br /> The function was called, and before it finished executing **SQLCancelHandle** was called on the *ConnectionHandle* from a different thread in a multithread application.|  
...
|---------------------------|---------|  
|Canceling a function running asynchronously on a connection handle.|[SQLCancelHandle Function](../content/SQLCancelHandle-Function.md)|  
