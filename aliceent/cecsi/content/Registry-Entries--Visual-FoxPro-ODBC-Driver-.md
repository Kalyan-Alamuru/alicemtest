...
|SourceType|REG_SZ|"DBC" or "DBF"|  
 ...
 You can use some of these keywords and values as parameters in the [SQLDriverConnect](../content/SQLDriverConnect--Visual-FoxPro-ODBC-Driver-.md) ODBC API function.