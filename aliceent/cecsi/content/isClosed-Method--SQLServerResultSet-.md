...
# isClosed Method (SQLServerResultSet)
  Indicates whether this [SQLServerResultSet](../content/SQLServerResultSet-Class.md) object has been closed.  
...
## Return Value  
 **true** if this [SQLServerResultSet](../content/SQLServerResultSet-Class.md) object is closed, **false** if it is still open.  
