---
title: "Using Azure Active Directory with the Windows ODBC Driver"
ms.custom: na
ms.date: 08/04/2016
...
The ODBC Driver 13.1 for SQL Server - Windows allows ODBC applications to connect to an instance of SQL Azure using a federated identity in Azure Active Directory with username/password or Windows Integrated Authentication. For more information about configuring Azure Active Directory for your SQL Server, see [Connecting to SQL Database or SQL Data Warehouse By Using Azure Active Directory](Authenticationhttps://azure.microsoft.com/en-us/documentation/articles/sql-database-aad-authentication/).
