 ...
 **{fn**  *scalar-function* **}**  
 ...
 where *scalar-function* is one of the functions listed in [Appendix E: Scalar Functions](../Topic/Appendix%20E:%20Scalar%20Functions.md). For more information about the scalar function escape sequence, see [Scalar Function Escape Sequence](../content/Scalar-Function-Escape-Sequence.md) in Appendix C: SQL Grammar.  
 ...
 **CONVERT(** *value_exp* **,** *data_type***)**  
 ...
 where *value_exp* is a column name, the result of another scalar function, or a literal value, and *data_type* is a keyword that matches the **#define** name that is used by an SQL data type identifier as defined in [Appendix D: Data Types](../Topic/Appendix%20D:%20Data%20Types.md). For example, the following SQL statement uses the **CONVERT** function to make sure that the output of the **CURDATE** function is a date, instead of a timestamp or character data:  
