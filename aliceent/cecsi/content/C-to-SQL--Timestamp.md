...
The identifier for the timestamp ODBC C data type is:  
 ...
 The following table shows the ODBC SQL data types to which timestamp C data may be converted. For an explanation of the columns and terms in the table, see [Converting Data from C to SQL Data Types](../content/Converting-Data-from-C-to-SQL-Data-Types.md).  
...
|SQL_TYPE_TIMESTAMP|Fractional seconds fields are not  truncated<br /><br /> Fractional seconds fields are truncated<br /><br /> Data value is not a valid timestamp|n/a<br /><br /> 22008<br /><br /> 22007|  
 ...
 For information about what values are valid in a SQL_C_TIMESTAMP structure, see [C Data Types](../content/C-Data-Types.md), earlier in this appendix.  
