...
```  
 ...
 When a batch of result-generating statements is executed, it returns one or more row counts or result sets. For information about how to retrieve these, see [Multiple Results](../content/Multiple-Results.md).  
...
```  
 ...
 For more information about parameters, see [Statement Parameters](../content/Statement-Parameters.md), later in this section.