...
-   If the SQL_DESC_TYPE record field is SQL_DATETIME or SQL_INTERVAL, the SQL_DESC_DATETIME_INTERVAL_CODE field must be one of the valid datetime or interval codes. (See the description of the SQL_DESC_DATETIME_INTERVAL_CODE field in [SQLSetDescField](../content/SQLSetDescField-Function.md).)  
...
|Getting a single descriptor field|[SQLGetDescField Function](../content/SQLGetDescField-Function.md)|  
|Getting multiple descriptor fields|[SQLGetDescRec Function](../content/SQLGetDescRec-Function.md)|  
|Setting single descriptor fields|[SQLSetDescField Function](../content/SQLSetDescField-Function.md)|  
