...
## Comments  
 **SQLRemoveTranslator** complements the [SQLInstallTranslatorEx](../content/SQLInstallTranslatorEx-Function.md) function and updates the component usage count in the system information. This function should be called only from a setup application.  
