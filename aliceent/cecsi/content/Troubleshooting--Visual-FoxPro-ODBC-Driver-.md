...
-   Check the **Fetch data in background** checkbox on the [ODBC Visual FoxPro Setup dialog box](../content/ODBC-Visual-FoxPro-Setup-Dialog-Box.md).  
  
-   Use the BackgroundFetch attribute keyword in your connection string.  
  
 For information on connection string attribute keywords, see [Using Connection Strings](../content/Using-Connection-Strings.md).  
...
## Using Data Definition Language (DDL) in Stored Procedures  
 ...
 For information on language you can use in stored procedures, see [Support for Rules, Triggers, Default Values, and Stored Procedures](../content/Support-for-Rules--Triggers--Default-Values--and-Stored-Procedures--Visual-FoxPro-ODBC-Driver-.md).  
