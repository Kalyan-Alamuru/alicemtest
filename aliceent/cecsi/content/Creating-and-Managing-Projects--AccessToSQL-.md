...
4.  In the right pane, review the options. For more information about these options, see [Project Settings (Conversion)](assetId:///bcebc635-c638-4ddb-924c-b9ccfef86388).  
  
5.  Change options as necessary.  
  
6.  Repeat the previous steps for the **Migration**, **GUI**, and **Type Mapping** pages.  
  
    -   For information about migration options, see [Project Settings (Migration)](assetId:///4caebc9c-8680-4b99-a8fa-89c43161c95d).  
  
    -   For information about user interface options, see [Project Settings (GUI)](assetId:///cf06baf1-8714-48a3-95dc-781f6ca53693).  
  
    -   For more information about data type mapping settings, see [Project Settings (Type Mapping)](assetId:///b87b9683-abed-4677-8c50-18bdba704655).  
  
    -   For information about SQL Azure settings, see [Project Settings (SQL Azure)](assetId:///bbb8a204-d0e4-4f0b-9709-271feb1f136e).  
...
SSMA creates the project file. You can now perform the next step of [adding one or more Access databases](assetId:///e944c740-4c8a-4bc1-b0ed-be57bc06dced).  
  
## Customizing Project Settings  
In addition to defining default project settings, which apply to all new SSMA projects, you can also customize the settings for each project. For more information, see [Setting Conversion and Migration Options](assetId:///0a7304df-2f35-4453-96ef-7ac83dea1167).  
  
When you customize data type mappings between source and target databases, you can define mappings at the project, database, or object level. For more information about type mapping, see [Mapping Source and Target Data Types](assetId:///b362a075-16e7-423f-b63f-e1e9f02844a9).  
...
## Next Step  
The next step in the migration process is to [add one or more Access databases](assetId:///e944c740-4c8a-4bc1-b0ed-be57bc06dced).  
