 ...
 **SQLManageDataSources** initially displays the **ODBC Data Source Administrator** dialog box, as shown in the following illustration.  
 ...
 ![ODBC Data Source Administrator dialog box](../content/media/CH23E.gif "CH23E")  
 ...
 ![Create New Data Source dialog box](../content/media/CH23F.gif "CH23F")  
...
## File DSNs  
 ...
 For more information on file data sources, see [Connecting Using File Data Sources](../content/Connecting-Using-File-Data-Sources.md), or see [SQLDriverConnect](../content/SQLDriverConnect-Function.md).  
...
## Managing Drivers  
 ...
 ![ODBC Data Source Administrator Drivers tab](../content/media/ch23g.gif "ch23g")  
...
## Tracing Options  
 ...
 ![ODBC Data Source Administrator Tracing tab](../content/media/Ch23h.gif "Ch23h")  
...
>  Support for Visual Studio Analyzer was removed beginning in Windows 8 (Visual Studio Analyzer was only included in older versions of Visual Studio.). For an alternative troubleshooting mechanism, use BID tracing.  
 ...
 For more information on tracing, see [Tracing](../content/Tracing.md). For more information about the **Trace** and **TraceFile** keywords, see [ODBC Subkey](../content/ODBC-Subkey.md).  
  
## Related Functions  
  
|For information about|See|  
|---------------------------|---------|  
|Creating data sources|[SQLCreateDataSource](../content/SQLCreateDataSource-Function.md)|