...
The Type Mapping page of the **Project Settings** dialog box contains settings that customize how SSMA converts DB2 data types into  SQL Server  data types.  
...
**Target Type**  
The target  SQL Server  data type for the specified DB2 data type.  
