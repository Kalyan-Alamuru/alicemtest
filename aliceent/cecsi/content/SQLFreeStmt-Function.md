...
## Example  
 It is a good programming practice to free handles. However, for simplicity, the following sample does not include code that frees allocated handles. For an example of how to free handles, see [SQLFreeHandle Function](../content/SQLFreeHandle-Function.md).  
...
|Closing a cursor|[SQLCloseCursor Function](../content/SQLCloseCursor-Function.md)|  
