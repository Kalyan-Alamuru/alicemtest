 ...
 **{**[**?=**]**call** *procedure-name*[**(**[*parameter*][**,**[*parameter*]]...**)**]**}**  
 ...
 For more information about the procedure call escape sequence, see [Procedure Call Escape Sequence](../content/Procedure-Call-Escape-Sequence.md) in Appendix C: SQL Grammar.  
...
```  
 ...
 For more information about procedures, see [Procedures](../content/Procedures-ODBC.md).