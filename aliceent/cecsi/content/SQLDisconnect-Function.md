...
|HY008|Operation canceled|Asynchronous processing was enabled for the *ConnectionHandle*. The function was called, and before it finshed executing [SQLCancelHandle Function](../content/SQLCancelHandle-Function.md) was called on the *ConnectionHandle*. Then the function was called again on the *ConnectionHandle*.<br /><br /> The function was called, and before it finished executing **SQLCancelHandle** was called on the *ConnectionHandle* from a different thread in a multithread application.|  
...
## Comments  
 ...
 For information about how an application uses **SQLDisconnect**, see [Disconnecting from a Data Source or Driver](../content/Disconnecting-from-a-Data-Source-or-Driver.md).  
...
## Code Example  
 See [Sample ODBC Program](../content/Sample-ODBC-Program.md), [SQLBrowseConnect Function](../content/SQLBrowseConnect-Function.md), and [SQLConnect Function](../content/SQLConnect-Function.md).  
...
|Freeing a connection handle|[SQLFreeConnect Function](../content/SQLFreeConnect-Function.md)|  
