...
This topic describes how to remove steps from a SQL Server Agent master job in SQL Server 2016 by using SQL Server Management Studio or  Transact\-SQL .  
...
For more information, see [sp_delete_jobstep (Transact-SQL)](assetId:///421ede8e-ad57-474a-9fb9-92f70a3e77e3).  
