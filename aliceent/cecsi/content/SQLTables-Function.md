 ...
 **SQLTables** returns the results as a standard result set, ordered by TABLE_TYPE, TABLE_CAT, TABLE_SCHEM, and TABLE_NAME. For information about how this information might be used, see [Uses of Catalog Data](../content/Uses-of-Catalog-Data.md).  
...
|TABLE_OWNER|TABLE_SCHEM|  
 ...
 The following table lists the columns in the result set. Additional columns beyond column 5 (REMARKS) can be defined by the driver. An application should gain access to driver-specific columns by counting down from the end of the result set instead of specifying an explicit ordinal position. For more information, see [Data Returned by Catalog Functions](../content/Data-Returned-by-Catalog-Functions.md).  
...
## Example  
 The following sample code does not free handles and connections. See [SQLFreeHandle Function](../content/SQLFreeHandle-Function.md) and [SQLFreeStmt Function](../content/SQLFreeStmt-Function.md) for code samples to free handles and statements.  
