...
**Use Output window**  
Opens the Management Studio Output window to display output of the command being run. Not all tools present output in a format that can be presented in the Output window. For more information, see [Output Window](assetId:///9808e00c-c8f6-45cc-896e-192b8420f747).  
