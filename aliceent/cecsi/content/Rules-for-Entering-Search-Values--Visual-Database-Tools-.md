...
-   **Quotation marks** Enclose text values in single quotation marks, as in this example for a last name:  
    ...
    If you are entering a search condition in the [Criteria Pane](../content/Criteria-Pane--Visual-Database-Tools-.md), you can simply type the text value and the Query and View Designer will automatically put single quotation marks around it.  
...
|**Pane**|**Date format**|  
|------------|-------------------|  
|Criteria|Locale-specific Database-specific ANSI standard<br /><br />Dates entered in the [Criteria Pane](../content/Criteria-Pane--Visual-Database-Tools-.md) are converted to a database-compatible format in the SQL pane.|  
