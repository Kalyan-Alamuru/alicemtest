...
These job step scripts may call stored procedures and extended stored procedures. A single  Transact\-SQL  job step can contain multiple batches and embedded GO commands. For more information on creating a job, see [Creating Jobs](../content/Create-Jobs.md).  
