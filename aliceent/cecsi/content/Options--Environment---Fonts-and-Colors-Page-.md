...
|Execution Plan|Changes to font style, size, and color display settings for this item affect the appearance of text in the Execution Plan of  Microsoft   SQL Server  and SQL Server Compact queries.|  
...
[Options (Text Editor/Editor Tab and Status Bar Page)](assetId:///e4815678-7885-4631-878f-c6a2b857ee05)  
