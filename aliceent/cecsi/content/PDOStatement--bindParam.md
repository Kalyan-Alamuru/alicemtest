...
## Remarks  
When binding null data to server columns of type varbinary, binary, or varbinary(max) you should specify binary encoding (PDO::SQLSRV_ENCODING_BINARY) using the $*driver_options*. See [Constants](../content/Constants--Microsoft-Drivers-for-PHP-for-SQL-Server-.md) for more information about encoding constants.  
