...
|<=|Less than or equal to|  
 ...
 When you use the = operator with strings, it acts differently, depending on the setting of SET ANSI. When SET ANSI is set to OFF, Visual FoxPro treats string comparisons in a manner familiar to Xbase users. When SET ANSI is set to ON, Visual FoxPro follows ANSI standards for string comparisons. See [SET ANSI](../content/SET-ANSI-Command.md) and [SET EXACT](../content/SET-EXACT-Command.md) for more information about how Visual FoxPro performs string comparisons.  
