...
```  
 ...
 As mentioned in the [Allocating and Freeing Buffers](../content/Allocating-and-Freeing-Buffers.md) section, the address of a deferred buffer must remain valid until the buffer is unbound.  
