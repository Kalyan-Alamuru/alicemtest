...
|State|Description|  
|-----------|-----------------|  
|S0|Unallocated statement. (The connection state must be C4, C5, or C6. For more information, see [Connection Transitions](../content/Connection-Transitions.md).)|  
...
|(IH)|S5 [s]  S11 [x]|S1 [e] S5 [s]  S11 [x]|S1 [e] and [1] S5 [s] and [1] S11 [x] and [1] 24000[2]|See next table|(HY010)|NS [c] (HY010) o|  
 ...
 [1]   The current result is the last or only result, or there are no current results. For more information about multiple results, see [Multiple Results](../content/Multiple-Results.md).  
...
|(IH)|S4 [s] and [nr] S5 [s] and [r] S8 [d]  S11 [x]|-- [e] and [1] S1 [e] and [2] S4 [s] and [nr] S5 [s] and [r] S8 [d]  S11 [x]|-- [e], [1], and [3] S1 [e], [2], and [3] S4 [s], [nr], and [3] S5 [s], [r], and [3] S8 [d] and [3] S11 [x] and [3] 24000 [4]|See next table|(HY010)|NS [c] (HY010) [o]|  
 ...
 [3]   The current result is the last or only result, or there are no current results. For more information about multiple results, see [Multiple Results](../content/Multiple-Results.md).  
