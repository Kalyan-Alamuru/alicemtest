...
This topic describes how to defect a target server from a master server in SQL Server 2016 by using SQL Server Management Studio,  Transact\-SQL , or SQL Server Management Objects (SMO). Run this procedure from the target server.  
