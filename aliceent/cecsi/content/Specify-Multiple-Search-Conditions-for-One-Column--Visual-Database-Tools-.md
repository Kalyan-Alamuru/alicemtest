---
title: "Specify Multiple Search Conditions for One Column (Visual Database Tools)"
ms.custom: na
ms.date: 08/15/2016
...
1.  In the [Criteria Pane](../content/Criteria-Pane--Visual-Database-Tools-.md), add the column to search.  
