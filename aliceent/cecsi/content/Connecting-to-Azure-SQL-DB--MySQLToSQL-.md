---
title: "Connecting to Azure SQL DB (MySQLToSQL)"
ms.custom: na
ms.date: 07/18/2016
ms.reviewer: na
ms.suite: na
...
-   To convert MySQL objects to  Transact\-SQL  syntax, to update metadata from SQL Azure, or to save converted syntax to scripts, the account must have permission to log on to the instance of SQL Azure.  
...
When you define the connection properties, you also specify the database where objects and data will be migrated. You can customize this mapping at the MySQL schema level after you connect to SQL Azure. For more information, see [Mapping MySQL Databases to SQL Server Schemas &#40;MySQLToSQL&#41;](../content/Mapping-MySQL-Databases-to-SQL-Server-Schemas--MySQLToSQL-.md)  
...
-   To customize the mapping between MySQL schemas and SQL Azure databases and schemas, see [Mapping MySQL Databases to SQL Server Schemas &#40;MySQLToSQL&#41;](../content/Mapping-MySQL-Databases-to-SQL-Server-Schemas--MySQLToSQL-.md)  
...
-   If you do not have to perform any of these tasks, you can convert the MySQL database object definitions into SQL Azure object definitions. For more information, see [Converting MySQL Databases &#40;MySQLToSQL&#41;](../content/Converting-MySQL-Databases--MySQLToSQL-.md)  
