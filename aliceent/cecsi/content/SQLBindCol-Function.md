...
-   SQL_COLUMN_IGNORE  
 ...
 For more information, see [SQLBulkOperations Function](../content/SQLBulkOperations-Function.md), [SQLFetch Function](../content/SQLFetch-Function.md), [SQLSetPos Function](../content/SQLSetPos-Function.md), and [Using Length/Indicator Values](../content/Using-Length-and-Indicator-Values.md).  
...
|HYC00|Optional feature not implemented|The driver or data source does not support the conversion specified by the combination of the *TargetType* argument and the driver-specific SQL data type of the corresponding column.<br /><br /> The argument *ColumnNumber* was 0 and the driver does not support bookmarks.<br /><br /> The driver supports only ODBC 2.*x* and the argument *TargetType* was one of the following:<br /><br /> SQL_C_NUMERIC SQL_C_SBIGINT SQL_C_UBIGINT<br /><br /> and any of the interval C data types listed in [C Data Types](../content/C-Data-Types.md) in Appendix D: Data Types.<br /><br /> The driver only supports ODBC versions prior to 3.50, and the argument *TargetType* was SQL_C_GUID.|  
|HYT01|Connection timeout expired|The connection timeout period expired before the data source responded to the request. The connection timeout period is set through **SQLSetConnectAttr**, SQL_ATTR_CONNECTION_TIMEOUT.|  
|IM001|Driver does not support this function|(DM) The driver associated with the *StatementHandle* does not support the function.|  
  
## Comments  
 **SQLBindCol** is used to associate, or *bind,* columns in the result set to data buffers and length/indicator buffers in the application. When the application calls **SQLFetch**, **SQLFetchScroll**, or **SQLSetPos** to fetch data, the driver returns the data for the bound columns in the specified buffers; for more information, see [SQLFetch Function](../content/SQLFetch-Function.md). When the application calls **SQLBulkOperations** to update or insert a row or **SQLSetPos** to update a row, the driver retrieves the data for the bound columns from the specified buffers; for more information, see [SQLBulkOperations Function](../content/SQLBulkOperations-Function.md) or [SQLSetPos Function](../content/SQLSetPos-Function.md). For more information about binding, see [Retrieving Results (Basic)](../content/Retrieving-Results--Basic-.md).  
  
 Notice that columns do not have to be bound to retrieve data from them. An application can also call **SQLGetData** to retrieve data from columns. Although it is possible to bind some columns in a row and call **SQLGetData** for others, this is subject to some restrictions. For more information, see [SQLGetData](../content/SQLGetData-Function.md).  
...
## Binding Arrays  
 If the rowset size (the value of the SQL_ATTR_ROW_ARRAY_SIZE statement attribute) is greater than 1, the application binds arrays of buffers instead of single buffers. For more information, see [Block Cursors](../content/Block-Cursors.md).  
...
> [!NOTE]  
>  An application must verify that alignment is valid. For more information about alignment considerations, see [Alignment](../content/Alignment.md).  
...
3.  Calls **SQLBindCol** with the following arguments:  
 ...
 For more information about how this information is used, see "Buffer Addresses," later in this section. For more information about column-wise binding, see [Column-Wise Binding](../content/Column-Wise-Binding.md).  
...
3.  Calls **SQLBindCol** with the following arguments for each column to be bound:  
 ...
 For more information about how this information is used, see "Buffer Addresses," later in this section. For more information about column-wise binding, see [Row-Wise Binding](../content/Row-Wise-Binding.md).  
...
## Code Example  
 ...
 For more code examples, see [SQLBulkOperations Function](../content/SQLBulkOperations-Function.md), [SQLColumns Function](../content/SQLColumns-Function.md), [SQLFetchScroll Function](../content/SQLFetchScroll-Function.md), and [SQLSetPos Function](../content/SQLSetPos-Function.md).  
...
|Releasing column buffers on the statement|[SQLFreeStmt Function](../content/SQLFreeStmt-Function.md)|  
