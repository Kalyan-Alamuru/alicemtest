---
title: "Create Make Table Queries (Visual Database Tools)"
ms.custom: na
ms.date: 08/15/2016
...
4.  Specify the columns to copy by adding them to the query. For details, see [Add Columns to Queries (Visual Database Tools)](../content/Add-Columns-to-Queries--Visual-Database-Tools-.md). Columns will be copied only if you add them to the query. To copy entire rows, choose **\&#42; (All Columns)**.  
...
6.  Specify the rows to copy by entering search conditions. For details, see [Specify Search Criteria (Visual Database Tools)](../content/Specify-Search-Criteria--Visual-Database-Tools-.md).  
...
7.  If you want to copy summary information, specify Group By options. For details, see [Summarize Query Results (Visual Database Tools)](../content/Summarize-Query-Results--Visual-Database-Tools-.md).  
  
When you execute a Make Table query, no results are reported in the [Results Pane](../content/Results-Pane--Visual-Database-Tools-.md). Instead, a message appears indicating how many rows were copied.  
