...
|HY117|Connection is suspended due to unknown transaction state. Only disconnect and read-only functions are allowed.|(DM) For more information about suspended state, see [What's New in ODBC 3.8](../content/What-s-New-in-ODBC-3.8.md).|  
 ...
 **SQL_DESC_BIND_OFFSET_PTR [Application descriptors]**  
 ...
 For more information, see the description of row-wise binding in [SQLFetchScroll](../content/SQLFetchScroll-Function.md) and [SQLBindParameter](../content/SQLBindParameter-Function.md).  
...
|SQL_INTERVAL_YEAR_TO_MONTH/ SQL_C_INTERVAL_YEAR_TO_MONTH|SQL_CODE_YEAR_TO_MONTH|  
 ...
 For more information about the data intervals and this field, see [Data Type Identifiers and Descriptors](../content/Data-Type-Identifiers-and-Descriptors.md).  
 ...
 **SQL_DESC_LENGTH [All]**  
 ...
 The value in this field may be different from the value for "length" as defined in ODBC 2*.x*. For more information, see [Appendix D: Data Types](../Topic/Appendix%20D:%20Data%20Types.md).  
 ...
 **SQL_DESC_NAME [Implementation descriptors]**  
 ...
 An application can set the SQL_DESC_NAME field of an IPD to a parameter name or alias to specify stored procedure parameters by name. (For more information, see [Binding Parameters by Name (Named Parameters)](../content/Binding-Parameters-by-Name--Named-Parameters-.md).) The SQL_DESC_NAME field of an IRD is a read-only field; SQLSTATE HY091 (Invalid descriptor field identifier) will be returned if an application attempts to set it.  
 ...
 **SQL_DESC_PRECISION [All]**  
 ...
 The value in this field may be different from the value for "precision" as defined in ODBC 2*.x*. For more information, see [Appendix D: Data Types](../Topic/Appendix%20D:%20Data%20Types.md).  
 ...
 **SQL_DESC_SCALE [All]**  
 ...
 The value in this field may be different from the value for "scale" as defined in ODBC 2*.x*. For more information, see [Appendix D: Data Types](../Topic/Appendix%20D:%20Data%20Types.md).  
...
|SQL_DECIMAL, SQL_NUMERIC, SQL_C_NUMERIC|SQL_DESC_SCALE is set to 0. SQL_DESC_PRECISION is set to the implementation-defined precision for the respective data type.<br /><br /> See [SQL to C: Numeric](../Topic/SQL%20to%20C:%20Numeric.md) for information on how to manually bind a SQL_C_NUMERIC value.|  
...
|---------------------------|---------|  
|Binding a column|[SQLBindCol Function](../content/SQLBindCol-Function.md)|  
|Binding a parameter|[SQLBindParameter Function](../content/SQLBindParameter-Function.md)|  
|Getting a descriptor field|[SQLGetDescField Function](../content/SQLGetDescField-Function.md)|  
|Getting multiple descriptor fields|[SQLGetDescRec Function](../content/SQLGetDescRec-Function.md)|  
|Setting multiple descriptor fields|[SQLSetDescRec Function](../content/SQLSetDescRec-Function.md)|  
