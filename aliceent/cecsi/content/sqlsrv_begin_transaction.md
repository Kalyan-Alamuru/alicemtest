...
---
# sqlsrv_begin_transaction
Begins a transaction on a specified connection. The current transaction includes all statements on the specified connection that were executed after the call to **sqlsrv_begin_transaction** and before any calls to [sqlsrv_rollback](../content/sqlsrv_rollback.md) or [sqlsrv_commit](../content/sqlsrv_commit.md).  
...
[How to: Perform Transactions](../Topic/How%20to:%20Perform%20Transactions.md)  
