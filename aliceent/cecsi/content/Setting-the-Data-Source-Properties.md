...
# Setting the Data Source Properties
 ...
 For more information about  SQL Server  data sources, see the [SQLServerDataSource](../content/SQLServerDataSource-Class.md) class. For an example of how to use the SQLServerDataSource class to make a connection to a  SQL Server  database, see [Data Source Sample](../content/Data-Source-Sample.md).  
