...
-   If you choose **True**, SSMA will compare the output value of this parameter after executing the procedure on Sybase with the corresponding value on  SQL Server   
