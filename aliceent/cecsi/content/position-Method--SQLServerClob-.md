...
|Name|Description|  
|----------|-----------------|  
|[position (java.sql.Clob, long)](../content/position-Method--java.sql.Clob--long-.md)|Returns the character position of the specified CLOB object in the CLOB based on the given starting position.|  
|[position (java.lang.String, long)](../content/position-Method--java.lang.String--long-.md)|Returns the character position of the specified substring in the CLOB based on the given starting position.|  
