...
-   **Browsing the system for all databases accessible to a particular driver.** For more information, see [Connecting with SQLBrowseConnect](../content/Connecting-with-SQLBrowseConnect.md), later in this section.