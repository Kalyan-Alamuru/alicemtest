...
|[execute (java.lang.String, int)](../content/execute-Method--java.lang.String--int-.md)|Runs the given SQL statement, which can return multiple results, and signals to  Microsoft JDBC Driver for SQL Server  that any auto-generated keys should be made available for retrieval.|  
