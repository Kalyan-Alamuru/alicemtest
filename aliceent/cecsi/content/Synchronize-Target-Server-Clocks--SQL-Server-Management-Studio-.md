...
This topic describes how to synchronize target server clocks in SQL Server 2016 with the master server clock by using SQL Server Management Studio or  Transact\-SQL . Synchronizing these system clocks supports your job schedules.  
