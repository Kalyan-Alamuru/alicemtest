...
|SQL_TYPE_DATE[6]|DATE|Year, month, and day fields, conforming to the rules of the Gregorian calendar. (See [Constraints of the Gregorian Calendar](../content/Constraints-of-the-Gregorian-Calendar.md), later in this appendix.)|  
...
|SQL_GUID|GUID|Fixed length GUID.|  
 ...
 [7]   For more information about the interval SQL data types, see the [Interval Data Types](../content/Interval-Data-Types.md) section, later in this appendix.  
