...
4.  Execute the query:  
    ...
    -   If you are using the PDO_SQLSRV driver, execute the query with [PDO::prepare](../Topic/PDO::prepare.md) and [PDOStatement::execute](../Topic/PDOStatement::execute.md). The topics for [PDO::prepare](../Topic/PDO::prepare.md) and [PDOStatement::execute](../Topic/PDOStatement::execute.md) have code examples.  
