...
1.  Places the new data values in the rowset buffers. For information on how to send long data with **SQLSetPos**, see [Long Data and SQLSetPos and SQLBulkOperations](../content/Long-Data-and-SQLSetPos-and-SQLBulkOperations.md).  
