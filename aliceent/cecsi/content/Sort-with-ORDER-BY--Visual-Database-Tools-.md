...
2.  In the [Criteria Pane](../content/Criteria-Pane--Visual-Database-Tools-.md), click the **Sort Type** column for the row corresponding to the column that you want to use to sort your query results.  
